# входни данни
# пилешко меню, риба меню, вегетарианско меню
# сума за пилешки = бр. пил * 10.35
# сума за риба = бр. риба * 12.40
# сума за вегет = бр. вегетар * 8.15
# сума от менютата = сума от пилешки + сума от риба + сума от вегетарианско
# сума за десерт = 20 % от сума за менютата
# крайна сума = сума от менютата + 2.50 (доставка) + сума за десерт
