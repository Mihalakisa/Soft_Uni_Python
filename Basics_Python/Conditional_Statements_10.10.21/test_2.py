...
pywhatkit.text_to_handwriting('Python is an easy to learn, powerful programming language. '
                              ...
                              'application development in many areas on most platforms.', rgb=(0, 0, 255))
