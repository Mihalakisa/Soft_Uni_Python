...
class SpaceStation:
    ...
    def send_on_mission(self, planet_name: str):
        ...
        if len(planet.items) == 0:
            ...
            return f"Planet: {planet_name} was explored. {participated_astronauts} astronauts participated " \
    ...
    @staticmethod
    def __create_astronaut(astronaut_types, name):
        if astronaut_types == Biologist.__name__:
            return Biologist(name)
        if astronaut_types == Geodesist.__name__:
            return Geodesist(name)
        if astronaut_types == Meteorologist.__name__:
